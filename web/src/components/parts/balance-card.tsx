    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col leading-tight">
          ...
          <span className="text-body-lg font-semibold leading-none text-midnight-black tabular-nums">
            {hasVaultValue ? fmtUsd(valueUsd!) : `${formatAmount(balance)} shares`}
          </span>
          {hasVaultValue && (
            <span className="text-caption font-medium tabular-nums text-subtle-gray">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col leading-tight">
        ...
        <span className="text-body-lg font-semibold text-midnight-black tabular-nums">
